...
POSITIVE_KEYWORDS = [
    ...
    "prompt engineering", "промпт инжиниринг", "промпт", "prompt", "промт", "promt",
    ...
    "chatgpt", "data science", "data scientist",
...
def send_telegram(text, parse_mode="HTML", reply_markup=None):
    ...
    return tg_multicast.send_multicast(
        ...
        parse_mode=parse_mode, reply_markup=reply_markup, tag="freelance.ru",
    )
